...
def attack0(dataset_name, seed, cuda, attack_node_arg=0.25, file_path='', LR=1e-3, TGT_LR=1e-2,
            EVAL_EPOCH=1000, TGT_EPOCH=1000, WARMUP_EPOCH=400, dropout=False, model_performance=True, setup='nocentrality',
            **kwargs):
    # Initialization
    print('Im here.', '-'*30)
    ...
    # Set ablation
    index_ablation = np.zeros(num_cycles)
    ...
    for cycle in range(num_cycles):
        ...
        if sub_train_mask_new.sum() < total_num:
            ...
            if setup == "random":
            ...
            elif setup == "nocentrality":
                print("Setup: Centrality Ablated")
                ## First: Representativeness
                ## Can be replaced by other centrality measurement
                Rank1 = rank_centrality(sub_g, sub_train_mask, sub_train_mask_new, num_each, return_rank=True)
                ## Second: Uncertainty
                ...
                if Rank1 is None:
                    print("Completed!")
                selected_indices = quantile_selection(Rank1, Rank2, Rank3, index_ablation[cycle], index_2[cycle],
                                                      index_3[cycle],
                                                      sub_train_mask, sub_train_mask_new, num_each)
                selected_indices_tensor = selected_indices.clone().detach()
                # th.tensor(, dtype = th.long)
            ...
            elif setup == "nouncertainty":
                print("Setup: Uncertainty Ablated")
                ## First: Representativeness
                ## Can be replaced by other centrality measurement
                Rank1 = rank_centrality(sub_g, sub_train_mask, sub_train_mask_new, num_each, return_rank=True)
                ## Second: Uncertainty
                ...
                if Rank1 is None:
                    print("Completed!")
                selected_indices = quantile_selection(Rank1, Rank2, Rank3, index_1[cycle], index_ablation[cycle],
                                                      index_3[cycle],
                                                      sub_train_mask, sub_train_mask_new, num_each)
                selected_indices_tensor = selected_indices.clone().detach()
                # th.tensor(, dtype = th.long)
            ...
            elif setup == "nodiversity":
                print("Setup: Diversity Ablated")
                ## First: Representativeness
                ## Can be replaced by other centrality measurement
                Rank1 = rank_centrality(sub_g, sub_train_mask, sub_train_mask_new, num_each, return_rank=True)
                ## Second: Uncertainty
            ...
            elif setup == "nocentrality_perturbation":
                print("Setup: Experiment with Perturbation with Centrality Ablated")
                Rank1 = rank_centrality(sub_g, sub_train_mask, sub_train_mask_new, num_each, return_rank=True)
                Rank2 = rank_perturb(net, sub_g, sub_features, num_perturbations,
                                     sub_train_mask, sub_train_mask_new, noise_level,
                                     num_each, return_rank=True)
            ...
            elif setup == "nodiversity_perturbation":
                print("Setup: Experiment with Perturbation with Diversity Ablated")
                Rank1 = rank_centrality(sub_g, sub_train_mask, sub_train_mask_new, num_each, return_rank=True)
                Rank2 = rank_perturb(net, sub_g, sub_features, num_perturbations,
                                     sub_train_mask, sub_train_mask_new, noise_level,
                                     num_each, return_rank=True)
