...
def load_data(dataset_name):
    ...
    g = data[0]
    features = th.tensor(g.ndata['feat'].numpy(), dtype=th.float32)
    labels = th.tensor(np.array(g.ndata['label']), dtype=th.int64)
...
def attack0(dataset_name, attack_node_arg, cuda):
    ...
    g1 = data1[0]
    labels1 = g1.ndata['label']
    test_mask1 = g1.ndata['test_mask']
...
# Accuracy:0.8001902949571836 Fedility:0.884871550903901